...
const features = [
  {
    ...
    description:
      "Advanced machine learning analyzes pitch patterns, market viability, and success probability in real-time.",
  ...
  },
  {
    ...
    description:
      "Immutable verification of startup metrics, revenue claims, and investor credentials through smart contracts.",
  ...
  },
  {
    ...
    description:
      "AI-powered connections between startups, investors, and mentors based on compatibility and success potential.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-xl text-muted-foreground">
            Our platform combines cutting-edge AI, blockchain security, and
            intelligent networking to revolutionize the startup ecosystem.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="relative p-8 bg-gradient-card border-card-border hover:scale-105 transition-all duration-500 group overflow-hidden"
            >
              {/* Background Glow */}
              <div
                className={`absolute -top-20 -right-20 w-40 h-40 ${feature.gradient} rounded-full blur-3xl opacity-10 group-hover:opacity-20 transition-opacity`}
              ></div>

              {/* Icon */}
              <div
                className={`w-16 h-16 ${feature.gradient} rounded-2xl flex items-center justify-center ${feature.glow} mb-6 relative z-10`}
              >
              ...
              <Button
                variant="outline"
                className="w-full relative z-10 group-hover:bg-card group-hover:border-primary/30"
              >
                Learn More
        ...
        <div className="mt-20 text-center">
          <h3 className="text-3xl font-bold mb-12">
            <span className="text-gradient-primary">Seamlessly Integrated</span>{" "}
            Ecosystem
          </h3>
